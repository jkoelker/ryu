...
def to_action(dp, dic):
    ...
    return ofctl_common.to_action(dic, ofp, parser, action_type, UTIL)
...
def to_match(dp, attrs):
    convert = {'in_port': UTIL.ofp_port_from_user,
               'in_phy_port': int,
               'metadata': ofctl_common.to_match_masked_int,
               'dl_dst': ofctl_common.to_match_eth,
               'dl_src': ofctl_common.to_match_eth,
               'eth_dst': ofctl_common.to_match_eth,
               'eth_src': ofctl_common.to_match_eth,
               'dl_type': int,
               'eth_type': int,
               ...
               'nw_proto': int,
               'ip_proto': int,
               'nw_src': ofctl_common.to_match_ip,
               'nw_dst': ofctl_common.to_match_ip,
               'ipv4_src': ofctl_common.to_match_ip,
               'ipv4_dst': ofctl_common.to_match_ip,
               'tp_src': int,
               'tp_dst': int,
               'tcp_src': int,
               'tcp_dst': int,
               ...
               'icmpv4_code': int,
               'arp_op': int,
               'arp_spa': ofctl_common.to_match_ip,
               'arp_tpa': ofctl_common.to_match_ip,
               'arp_sha': ofctl_common.to_match_eth,
               'arp_tha': ofctl_common.to_match_eth,
               'ipv6_src': ofctl_common.to_match_ip,
               'ipv6_dst': ofctl_common.to_match_ip,
               'ipv6_flabel': int,
               'icmpv6_type': int,
               'icmpv6_code': int,
               'ipv6_nd_target': ofctl_common.to_match_ip,
               'ipv6_nd_sll': ofctl_common.to_match_eth,
               'ipv6_nd_tll': ofctl_common.to_match_eth,
               'mpls_label': int,
               'mpls_tc': int,
               'mpls_bos': int,
               'pbb_isid': ofctl_common.to_match_masked_int,
               'tunnel_id': ofctl_common.to_match_masked_int,
               'ipv6_exthdr': ofctl_common.to_match_masked_int}
...
def to_match_vid(value):
    return ofctl_common.to_match_vid(value, ofproto_v1_3.OFPVID_PRESENT)
...
def match_to_str(ofmatch):
    ...
    for match_field in ofmatch:
        ...
        if key == 'dl_vlan':
            value = ofctl_common.match_vid_to_str(value, mask,
